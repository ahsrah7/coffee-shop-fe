...
function ProductCard({image,name,price,description}) {
  ...
  return (
    ...
    <div className='absolute border-2 border-deepLagoanBlue  rounded-full align-middle px-2 py-1 -top-1 -right-1 hover:cursor-pointer hover:bg-deepLagoanBlue ' onClick={()=>checkoutHandler({name,amount:price})}>
